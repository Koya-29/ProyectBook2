...
export class LibroFormComponent {
  ...
  form = new FormGroup({
    'cantidad': new FormControl(0, [Validators.minLength(1), Validators.maxLength(60), Validators.required]),
    'cantidad_disponible': new FormControl(0, [Validators.minLength(1), Validators.maxLength(60), Validators.required]),
    'cantidad_prestado': new FormControl(0, [Validators.minLength(1), Validators.maxLength(60), Validators.required]),
    'editorial': new FormControl('', [Validators.minLength(2), Validators.maxLength(60), Validators.required]),
